...
Ext.define('backoffice.view.maestros.categoria.ListadoCategoria', {
    extend: 'Ext.panel.Panel',
    xtype: 'listado-categoria',
    requires: [
        'backoffice.view.maestros.categoria.ListadoCategoriaController',
        'backoffice.view.maestros.categoria.ListadoCategoriaModel'
    ],

    controller: 'maestros-categoria-listadocategoria',
    viewModel: {
        type: 'maestros-categoria-listadocategoria'
    },
    ...
    _titulo: function () {
        return {
            xtype: 'container',
            userCls: 'big-100 small-100',
            html: '<h2>Información de Categorias</h2>'

        }
    },
    _grilla: function () {
       let store = tools.Util.getStoreById('stCategory');
