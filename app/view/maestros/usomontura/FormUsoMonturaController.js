Ext.define('backoffice.view.maestros.usomontura.FormUsoMonturaController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.maestros-usomontura-formusomontura',
    ...
    onClickGuardar: function () {
        ...
        _id  = tools.Util.getById('iduse_mount').getValue();
    
        form.submit({
            url :  (_id!=0? Ext.manifest.api + 'usemount/'+ _id.toString(): Ext.manifest.api+'usemount'),
