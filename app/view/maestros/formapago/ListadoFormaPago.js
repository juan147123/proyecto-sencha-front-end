...
Ext.define('backoffice.view.maestros.formapago.ListadoFormaPago',{
    extend: 'Ext.panel.Panel',

    xtype: 'listado-formapago',

    requires: [
        'backoffice.view.maestros.formapago.ListadoFormaPagoController',
        'backoffice.view.maestros.formapago.ListadoFormaPagoModel'
    ],

    controller: 'maestros-formapago-listadoformapago',
    viewModel: {
        type: 'maestros-formapago-listadoformapago'
    },
    ...
    _titulo: function () {
        return {
            xtype: 'container',
            userCls: 'big-100 small-100',
            html: '<h2>Información de Formas de Pago</h2>'

        }
    },
    _grilla: function () {
        let _store = tools.Util.getStoreById('stFormaPago');
