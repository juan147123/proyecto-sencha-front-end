...
Ext.define('backoffice.view.maestros.descuento.ListadoDescuento',{
    extend: 'Ext.panel.Panel',
    xtype: 'listado-descuento',

    requires: [
        'backoffice.view.maestros.descuento.ListadoDescuentoController',
        'backoffice.view.maestros.descuento.ListadoDescuentoModel'
    ],
