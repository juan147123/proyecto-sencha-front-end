Ext.define('backoffice.view.maestros.marca.ListadoMarca', {
    extend: 'Ext.panel.Panel',
    xtype: 'marca-listadoMarca',
    requires: [
     'backoffice.view.maestros.marca.ListadoMarcaController'  
    ],
    controller: 'marca-listadoMarca',
    // viewModel: {
    //     type:'marca-listadoMarca'
    // },
    layout:{
        ...
        return {
            ...
            items: [
                '->',
                {
                    ui: 'button-sistema',
                    text: 'NUEVO',
                    tooltip: 'Agrega un registro de nueva Marca',
                    listeners: {
                        click: 'onClickNuevo'
                    }
                },
    ...
    _titulo: function () {
        return {
            xtype: 'container',
            userCls: 'big-100 small-100',
            html: '<h2>Información de Marcas</h2>'

        }
    },
    _grilla: function () {
        let store = tools.Util.getStoreById('stBrand');
