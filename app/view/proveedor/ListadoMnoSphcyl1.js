...
Ext.define('backoffice.view.proveedor.ListadoMnoSphcyl1',{
    extend: 'Ext.grid.Panel',
    xtype : 'proveedor-ListadoMonoSphCyl1',
    requires: [
        'backoffice.view.proveedor.ListadoMnoSphcyl1Controller',
        'backoffice.view.proveedor.ListadoMnoSphcyl1Model'
    ],

    controller: 'proveedor-listadomnosphcyl1',
    viewModel: {
        type: 'proveedor-listadomnosphcyl1'
    },
    ...
    initComponent: function () {
        ...
        store  = tools.Util.getStoreById('stPedidoTerminadoMonosphCyl1').load();
