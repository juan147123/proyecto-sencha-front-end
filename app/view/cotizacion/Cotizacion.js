...
Ext.define('backoffice.view.cotizacion.Cotizacion', {
    extend: 'Ext.form.Panel',
    xtype: 'cotizacion-registro',
    requires: [
        'Ext.Img',
        'backoffice.view.cotizacion.CotizacionController',
        'backoffice.view.cotizacion.CotizacionModel',
        'Ext.grid.plugin.RowEditing'
    ],

    controller: 'cotizacion-listado',
    viewModel: {
        type: 'cotizacion-listado'
    },
    layout: {
    ...
    _titulo: function () {
        return {
            ...
            html: '<div style="font-size:25px;text-align:right;">Nueva Cotización</div>'
    ...
    _grilla: function () {
        let _detalle = tools.Util.getStoreById('stDetalleCotizacion');
        _detalle.removeAll();
